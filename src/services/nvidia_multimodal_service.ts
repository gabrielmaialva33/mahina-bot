...
export const NVIDIA_MULTIMODAL_MODELS: Record<string, NvidiaMultimodalModel> = {
  ...
  'deepseek-v4-flash': {
    ...
    description: 'Fast DeepSeek V4 reasoning model with thinking controls on NVIDIA NIM',
    category: 'reasoning',
    ...
    topP: 0.95,
    maxTokens: 16384,
    features: ['advanced-reasoning', 'coding', 'streaming', 'thinking-control'],
    costPerMillion: 0.9,
    latency: 'medium',
  },
  'deepseek-v4-pro': {
    ...
    description: 'Large-context DeepSeek V4 model for coding and complex agentic tasks',
    category: 'coding',
    ...
    topP: 0.95,
    maxTokens: 16384,
    features: ['coding', 'advanced-reasoning', 'long-context', 'agentic-workflows'],
    costPerMillion: 1.2,
    latency: 'high',
  },
  'nemotron-3-super': {
    ...
    description:
      'Hybrid Mamba-Transformer MoE with 1M context for agentic reasoning, planning, coding, and tool calling',
    category: 'reasoning',
    contextLength: 1000000,
    streaming: true,
    temperature: 0.7,
    topP: 0.9,
    maxTokens: 16384,
    features: ['advanced-reasoning', 'tool-calling', 'coding', 'planning', 'long-context'],
    costPerMillion: 1.6,
    latency: 'high',
  },
  'glm-4.7': {
    ...
    topP: 0.9,
    maxTokens: 8192,
    features: ['coding', 'tool-calling', 'ui-skills', 'multilingual'],
    costPerMillion: 0.9,
    latency: 'medium',
  },
  'glm-5.1': {
    id: 'z-ai/glm5.1',
    name: 'GLM 5.1',
    description: 'Flagship model for agentic workflows, coding, and long-horizon reasoning',
    category: 'reasoning',
    ...
    topP: 0.9,
    maxTokens: 16384,
    features: ['agentic-workflows', 'coding', 'long-horizon-reasoning'],
    costPerMillion: 1.3,
    latency: 'high',
  },
  'minimax-m2.7': {
    ...
    name: 'MiniMax M2.7',
    description: 'Large text model for coding, reasoning, and office-style tasks',
    category: 'general',
    contextLength: 74000,
    streaming: true,
    temperature: 0.7,
    topP: 0.95,
    maxTokens: 8192,
    features: ['coding', 'reasoning', 'office-tasks'],
    costPerMillion: 0.8,
    latency: 'medium',
  },
  'qwen3-235b': {
